...
hw.module @test(in %arg0: i32, in %arg1: i32, in %arg2: i32, in %arg3: i32, out out0: i32, out out1: i32) {
  // CHECK-DAG: "rtlil.cell"(%[[OP1:.+]], %[[OP2:.+]], %[[RES1:.+]]) <{{.*name = "\$%[0-9]+".*type = "\$and".*}}> : (!rtlil<val[32 : i32]>, !rtlil<val[32 : i32]>, !rtlil<val[32 : i32]>) -> ()
  // CHECK-DAG: "rtlil.cell"(%[[OP3:.+]], %[[OP4:.+]], %[[RES2:.+]]) <{{.*name = "\$%[0-9]+".*type = "\$and".*}}> : (!rtlil<val[32 : i32]>, !rtlil<val[32 : i32]>, !rtlil<val[32 : i32]>) -> ()
